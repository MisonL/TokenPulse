    ...
    static async resolve(
        ...
        if (tokenData.id_token) {
            ...
            if (jwtPayload) {
                ...
                identity.name = identity.name || jwtPayload.name || jwtPayload.preferred_username;
            }
        }
        ...
        identity.email = identity.email || tokenData.email || tokenData.account?.email_address;
