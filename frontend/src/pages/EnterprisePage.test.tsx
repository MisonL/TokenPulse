...
describe("EnterprisePage 治理辅助逻辑", () => {
  ...
  it("应在组织域只读降级时给出清晰的禁用提示", () => {
    expect(
      ...
      organizationWriteHint: ORG_DOMAIN_READONLY_FALLBACK_MESSAGE,
      projectWriteHint: ORG_DOMAIN_READONLY_FALLBACK_MESSAGE,
      memberBindingWriteHint: ORG_DOMAIN_READONLY_FALLBACK_MESSAGE,
    });
  });
  ...
  it("组织域写操作应统一经由 write guard，并在加载中优先阻断", () => {
    ...
    expect(orgAdaptersSource).toContain("ORG_DOMAIN_READONLY_FALLBACK_MESSAGE");
  });
